...
def generate_book_outline(writing_style, book_description, num_chapters, genre):
    ...
    3. An estimated word count for the chapter

    Ensure the outline covers a complete story arc with proper pacing and character development.
    Vary the chapter lengths as appropriate for the content and pacing of the story.
    ...
    try:
        outline = generate_text(outline_prompt, max_tokens=4000)
        return outline
    except Exception as e:
